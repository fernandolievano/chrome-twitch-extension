  ...
  return (
    <div className="flex justify-center pt-8">
      <a
        ...
        className='flex items-center justify-start bg-primary-color border-2 border-primary-color px-4 py-4 rounded font-bold shadow transition-all hover:shadow-2xl hover:scale-[1.01]'
      >
